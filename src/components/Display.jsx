...
const Display = ({ setActiveTab, activeTab }) => {
  ...
  useEffect(() => {
    ...
    axios.get('https://lambdapeeler-675999984030.herokuapp.com/dashboard/layers/list', {
    ...
    axios.get('https://lambdapeeler-675999984030.herokuapp.com/dashboard/functions/list', {
      withCredentials: true,
    })
    .then(response => {
      ...
      // </div>
        ...
        >
          <ToggleButton
            ...
            sx={{
              width: '8em',
              backgroundColor: activeTab === 'Layers' ? theme.palette.primary : 'inherit',
            }}
          >
            Layers
          </ToggleButton>
          <ToggleButton
            ...
            sx={{
              width: '8em',
              backgroundColor: activeTab === 'Functions' ? theme.palette.primary : 'inherit',
            }}
          >
            Functions
          </ToggleButton>
      ...
      // </div>
          ...
          >
            <ToggleButton
              ...
              sx={{
                width: '10em',
                backgroundColor: activeTab === 'Notifications' ? theme.palette.primary : 'inherit',
              }}
            >
              Error Log
            </ToggleButton>
            <ToggleButton
              ...
              sx={{
                width: '10em',
                backgroundColor: activeTab === 'History' ? theme.palette.primary : 'inherit',
              }}
            >
              Success Log
            </ToggleButton>
