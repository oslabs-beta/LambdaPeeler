...
// import { STSClient, 
//   AssumeRoleCommand } from '@aws-sdk/client-sts';
...
// functionController.assumeRole = async (req: any, res: any, next: any) => {
//   try {
...
// functionController.getFunction = async (req: any, res: any, next: any) => {
//   try {
//     const input = {};
...
// functionController.getLayers = async(req: any, res: any, next: any) => {
...
//       Configuration.Layers.map((el: any) => {
...
//         layer["ARN"].map((layerARN: string, index: number) => {
...
//   functionController.removeLayer = async (req: any, res: any, next: any) => {
//     try {
...
//         const newArray = Configuration.Layers.filter((layer: any) => {
//           return layer.Arn !== ARN;
//         });
//         // update the configuration of functionName using the new Layers array
//         const updateInput = {
//           FunctionName: functionName,
//           Layers: newArray.map((element: any) => element.Arn),
//         };
